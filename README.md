Dokładniejsze i obszerniejsze odpowiedzi znajdują się w pliku [document.tex](document.tex). Jest to dokument LaTeX, który [TUTAJ](https://www.overleaf.com) może zostać skompilowany do formatu *.pdf.
